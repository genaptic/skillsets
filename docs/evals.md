...
| `python-cli-error-output-vs-python-domain-exception-policy`<br>A: `$python-cli-error-output`<br>B: `$python-domain-exception-policy` | `exceptions`, `failure contract`, `logging` | `$python-cli-error-output` | `$python-domain-exception-policy` | both | none |
| `python-cli-testing-vs-python-test-architecture`<br>A: `$python-cli-testing`<br>B: `$python-test-architecture` | `fixtures`, `integration tests`, `test matrix` | `$python-cli-testing` | `$python-test-architecture` | both | none |
| `python-project-layout-vs-python-test-architecture`<br>A: `$python-project-layout`<br>B: `$python-test-architecture` | `package boundaries`, `repository layout`, `test placement` | `$python-project-layout` | `$python-test-architecture` | both | none |

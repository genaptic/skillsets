...
| `python-cli-error-output-vs-python-exception-architecture`<br>A: `$python-cli-error-output`<br>B: `$python-exception-architecture` | `exceptions`, `failure contract`, `logging` | `$python-cli-error-output` | `$python-exception-architecture` | both | none |

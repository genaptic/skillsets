...
```bash
bash dist/install/postgres-databases.sh --dry-run
```

```powershell
.\dist\install\postgres-databases.ps1 -DryRun
```
...
Expected release tag (not yet created): `postgres-databases-v1.0.0`.

...
|---|---|---|---|
| `python-best-practices` | `python-best-practices.sh` | `python-best-practices.ps1` | `unpublished; explicit SHA required` |
| `python-cli-apps` | `python-cli-apps.sh` | `python-cli-apps.ps1` | `unpublished; explicit SHA required` |
| `rust-best-practices` | `rust-best-practices.sh` | `rust-best-practices.ps1` | `unpublished; explicit SHA required` |
| `rust-cli-apps` | `rust-cli-apps.sh` | `rust-cli-apps.ps1` | `unpublished; explicit SHA required` |
| `postgres-databases` | `postgres-databases.sh` | `postgres-databases.ps1` | `unpublished; explicit SHA required` |
| `repository-development` | `repository-development.sh` | `repository-development.ps1` | `unpublished; explicit SHA required` |

...
`genaptic-skillsets-create-skillpack` when the proposed skill:
...
2. **Routing:** positive, negative, and contextual per-skill evals plus reviewed four-outcome
   root boundary matrices.

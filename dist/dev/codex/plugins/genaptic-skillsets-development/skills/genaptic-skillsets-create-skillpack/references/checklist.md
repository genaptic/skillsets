# Completion checklist for a new skillpack
...
- [ ] The pack has authored 25–120 character installation copy and 2–4 unique starter prompts naming declared `$skill-id` values.
...
- [ ] Every skill has explicit, implicit, contextual, and negative routing cases.
- [ ] Every skill has focused and end-to-end behavior cases.
- [ ] Assertions are observable and forbidden actions cover material risk.
- [ ] Every affected pair has A-only, B-only, both, and neither cases in the root matrix.
- [ ] Existing neighboring skills are included only through reviewed declared boundaries.
